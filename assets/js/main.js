...
function popBalance(){
        var width = 270;
        var height = 395;
        var merchantID = 3120215;

        window.open('https://wwws.givex.com/Merchant_pages/3120215_en', 'balanceWindow', 'width='+width+', height='+height+', left=0, top=0, menubar=0, toolbar=0, status=0, resizable=0');
      }
